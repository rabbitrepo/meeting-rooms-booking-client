...
export default function Page() {
    ...
    return (
        <ScrollArea className="h-screen">
            <div className="flex flex-col space-y-4 m-20 mt-10">
                <Card>
                    <CardHeader>
                        <CardTitle>เลือกห้องประชุม</CardTitle>
                    </CardHeader>
                ...
                <div className='flex space-x-4'>
                    <Card className='flex-1'>
                        <CardHeader>
                            <CardTitle>เลือกวันที่-เวลา</CardTitle>
                        </CardHeader>
                    ...
                    <Card className='flex-1'>
                        ...
                        <CardContent>
                            <strong>สาขา:</strong> {selectedBranch ? selectedBranch.name : "-"}
                            <br />
                            <strong>ห้องประชุม:</strong> {selectedRoom ? selectedRoom.name : "-"}
                            <br />
                            <strong>วันที่:</strong> {selectedDate ? formattedSelectedDate : "-"}
                            <br />
                            <strong>เวลา:</strong> {startTime} - {endTime}
                        </CardContent>
                        <CardFooter className='flex justify-center space-x-4'>
                            <Button variant="secondary" className='' asChild>
                                <Link href="/poc/reservation/meetingroom">
                                    ยกเลิก
                                </Link>
                            </Button>
                            <Button onClick={handleCreateEvent}>ยืนยัน</Button>
                        </CardFooter>
                    </Card>
                </div>
            </div>
